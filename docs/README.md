...
| [Set dietary restrictions](howto-dietary-restrictions.md) | Tag members and recipes with dietary requirements |
| [Flag a recipe for night-before prep](explanation-conflict-detection.md) | Add the 🌙 indicator for recipes that need soaking, marinating, or defrosting |
...
| [Dietary Tags](reference-dietary-tags.md) | The 7 supported restriction tags and how dietary data is used |
...
| [Dietary Conflict Detection & Night-Before Prep](explanation-conflict-detection.md) | How the 🌙 prep indicator works; why the conflict red dot was removed |
